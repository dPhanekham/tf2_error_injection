...
sample_size_0001_error_train_history = {}
try:
  sample_size_0001_error_train_history = np.load('batch_results/sample_size_train_history_error_rate_0001_hidden_layer_inject_2.npy', allow_pickle=True, fix_imports=True)
...
for sample_size in sample_sizes:
  ...
  if sample_size not in sample_size_0001_error_train_history:
    sample_size_0001_error_train_history[sample_size] = {}
    sample_size_0001_error_train_history[sample_size]['training_accuracy'] = []
    sample_size_0001_error_train_history[sample_size]['training_loss'] = []
    sample_size_0001_error_train_history[sample_size]['validation_accuracy'] = []
    sample_size_0001_error_train_history[sample_size]['validation_loss'] = []
...
#                                        batch_size=32, verbose=0)
    ...
    sample_size_0001_error_train_history[sample_size]['training_loss'].append(sample_size_history_tmp[0])
    sample_size_0001_error_train_history[sample_size]['training_accuracy'].append(sample_size_history_tmp[1])
    sample_size_0001_error_train_history[sample_size]['validation_loss'].append(sample_size_history_tmp[2])
    sample_size_0001_error_train_history[sample_size]['validation_accuracy'].append(sample_size_history_tmp[3])

    np.save('batch_results/sample_size_train_history_error_rate_0001_hidden_layer_inject_2', sample_size_0001_error_train_history, allow_pickle=True, fix_imports=True)
