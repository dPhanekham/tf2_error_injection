...
try:
  sample_size_error_train_history = np.load('batch_results/sample_size_train_history_error_rate_000001.npy', allow_pickle=True, fix_imports=True)
...
#                                        batch_size=32, verbose=0)
    ...
    np.save('batch_results/sample_size_train_history_error_rate_000001', sample_size_error_train_history, allow_pickle=True, fix_imports=True)
