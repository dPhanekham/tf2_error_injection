...
try:
  sample_size_00001_error_train_history = np.load('batch_results/sample_size_train_history_error_rate_00001_dropout_20.npy', allow_pickle=True, fix_imports=True)
...
np.save('batch_results/sample_size_train_history_error_rate_00001_dropout_20', sample_size_00001_error_train_history, allow_pickle=True, fix_imports=True)
